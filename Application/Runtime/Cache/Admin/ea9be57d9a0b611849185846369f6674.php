...
<div class="pd-20">
  ...
  <table class="table table-border table-bordered table-bg table-hover table-sort">
    ...
    <tbody id="tb">
    	<tr v-for="ls in list" class="text-c"><td><input type="checkbox" value="" name=""></td><td>{{ls.id}}</td><td class="text-l"><u style="cursor:pointer" class="text-primary" onclick="article_edit(" 10001','650','','查看','article-zhang.html')'="" title="查看">{{ls.title}}</u></td><td>行业动态</td><td>H-ui</td><td>2014-6-11 11:11:42</td><td>21212</td><td class="article-status"><span class="label label-success radius">已发布</span></td><td class="f-14 article-manage"><a style="text-decoration:none" onclick="article_xiajia(this," 10001')'="" href="javascript:;" title="下架"><i class="icon-hand-down"></i></a> <a style="text-decoration:none" class="ml-5" onclick="article_edit(" 10001','','','资讯编辑','article-edit.html')'="" href="javascript:;" title="编辑"><i class="icon-edit"></i></a> <a style="text-decoration:none" class="ml-5" onclick="article_del(this," 10001')'="" href="javascript:;" title="删除"><i class="icon-trash"></i></a></td></tr>
    </tbody>
...
<script type="text/javascript" src="/Public/lib/layer1.8/layer.min.js"></script>
<script type="text/javascript" src="/Public/lib/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" src="/Public/lib/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="/Public/js/H-ui.js"></script>
<script type="text/javascript" src="/Public/js/H-ui.admin.js"></script> 
<script type="text/javascript" src="/Public/js/H-ui.admin.doc.js"></script>
...
$.getJSON("<?php echo ('ajaxList');?>", {p: 1}, function(res){
	mode.list = res.list;
    laypage({
    cont: $('#pageNav'),
    pages: res.count, //总页数
    ...
    jump: function(obj, first){
    	if(!first){
    	var curr = obj.curr;
    	$.getJSON("<?php echo ('ajaxList');?>", {p: curr}, function(r){
    		mode.list = r.list;
    	});
    	}
    }
