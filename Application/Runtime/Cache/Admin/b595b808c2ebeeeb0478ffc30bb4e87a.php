...
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.2" href="/">后台管理系统</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.2</span> <span class="Hui-userbox"><span class="c-white">管理员：<?php echo ($username); ?></span> <a class="btn btn-danger radius ml-10" onmouseover="shake(this)" href="<?php echo U('Index/loginout');?>" title="退出"><i class="icon-off"></i> <span>退出</span></a></span> <a aria-hidden="false" class="Hui-nav-toggle" href="#"></a> </header>
    ...
    <dl id="menu-article">
      ...
      <dd>
        <ul>
          ...
          <li><a _href="<?php echo U('Article/ArticleList');?>" href="javascript:void(0)">资讯管理</a></li>
        </ul>
      </dd>
    </dl>
    <dl id="menu-picture">
...
<script type="text/javascript" src="/Public/lib/Validform_v5.3.2.js"></script> 
...
<script type="text/javascript" src="/Public/js/jquery.shake.js"></script> 
<script>
function shake(a){
$(a).shake();
}
